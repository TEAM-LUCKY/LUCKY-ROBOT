...
class Config(object):
    ...
    TOKEN = ":AAGIrULRGNLtnRS_L2WthQssSsIFss1xfS0"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    MONGO_PORT = 27017
    MONGO_DB = "mongodb+srv://Ziddiboy:vijayrao1703@cluster0.4wbux.mongodb.net/?retryWrites=true&w=majority"
