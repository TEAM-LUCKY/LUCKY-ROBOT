...
PM_START_TEXT = """
*ʜᴇʟʟᴏ {} !*
**✪ ᴍʏ ɴᴀᴍᴇ ɪs ʟᴜᴄᴋʏ ʀᴏʙᴏᴛ [✨](https://telegra.ph/file/47d945d51ea33d7f68cfd.jpg)
...
HELP_STRINGS = """
» *ʜᴇʀᴇ ɪꜱ ᴍᴀʜ ᴇxᴄʟᴜsɪᴠᴇ ꜰᴇᴀᴛᴜʀᴇs* «
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text=f"๏ ʜᴇʟʟᴏ 🖤 ɪ ᴀᴍ *{dispatcher.bot.first_name}*, ᴀ ᴘᴏᴡᴇʀꜰᴜʟʟ ɢʀᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀꜱɪʟʏ."
