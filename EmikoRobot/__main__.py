...
PM_START_TEXT = """
*ʜᴇʟʟᴏ {} !*\n\n
✪ ᴍʏ ɴᴀᴍᴇ ɪs ʟᴜᴄᴋʏ ʀᴏʙᴏᴛ [✨](https://telegra.ph/file/b01682c4a537f38d98bc6.jpg)
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text=f"๏ ʜᴇʟʟᴏ 👋 ɪ ᴀᴍ 「 ʟᴜᴄᴋʏ 𒆜 ʀᴏʙᴏᴛ 」, ᴀ ᴘᴏᴡᴇʀғᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀsɪʟʏ.
...
「 ʟᴜᴄᴋʏ 𒆜 ʀᴏʙᴏᴛ 」's ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ ɢɴᴜ ɢᴇɴᴇʀᴀʟ ᴘᴜʙʟɪᴄ ʟɪᴄᴇɴsᴇ ᴠ3.0

 Now Enzo with me「 ʟᴜᴄᴋʏ 𒆜 ʀᴏʙᴏᴛ 」.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
